...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheRpgEngineApi.Vector4();
  });
  ...
  describe('Vector4', function() {
    it('should create an instance of Vector4', function() {
      // uncomment below and update the code to test Vector4
      //var instance = new TheRpgEngineApi.Vector4();
      //expect(instance).to.be.a(TheRpgEngineApi.Vector4);
    });
