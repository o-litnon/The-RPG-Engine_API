...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheRpgEngineApi.PropTransform();
  });
  ...
  describe('PropTransform', function() {
    it('should create an instance of PropTransform', function() {
      // uncomment below and update the code to test PropTransform
      //var instance = new TheRpgEngineApi.PropTransform();
      //expect(instance).to.be.a(TheRpgEngineApi.PropTransform);
    });
