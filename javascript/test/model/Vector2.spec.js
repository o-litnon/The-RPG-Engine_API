...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheRpgEngineApi.Vector2();
  });
  ...
  describe('Vector2', function() {
    it('should create an instance of Vector2', function() {
      // uncomment below and update the code to test Vector2
      //var instance = new TheRpgEngineApi.Vector2();
      //expect(instance).to.be.a(TheRpgEngineApi.Vector2);
    });
