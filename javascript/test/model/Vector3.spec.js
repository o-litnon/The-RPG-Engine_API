...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheRpgEngineApi.Vector3();
  });
  ...
  describe('Vector3', function() {
    it('should create an instance of Vector3', function() {
      // uncomment below and update the code to test Vector3
      //var instance = new TheRpgEngineApi.Vector3();
      //expect(instance).to.be.a(TheRpgEngineApi.Vector3);
    });
