...
(function(root, factory) {
  ...
  beforeEach(function() {
    instance = new TheRpgEngineApi.Vector3Int();
  });
  ...
  describe('Vector3Int', function() {
    it('should create an instance of Vector3Int', function() {
      // uncomment below and update the code to test Vector3Int
      //var instance = new TheRpgEngineApi.Vector3Int();
      //expect(instance).to.be.a(TheRpgEngineApi.Vector3Int);
    });
