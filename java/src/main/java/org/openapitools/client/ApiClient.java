...
public class ApiClient {
    ...
    private String basePath = "http://localhost:8001/TheRpgEngine";
    protected List<ServerConfiguration> servers = new ArrayList<ServerConfiguration>(Arrays.asList(
    new ServerConfiguration(
      "http://localhost:8001/TheRpgEngine",
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g http://localhost:8001/TheRpgEngine
